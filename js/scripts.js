...
let currentGrade = (currentPoints,totalPoints) =>  Math.round((currentPoints/totalPoints) * 100);
console.log(currentGrade(currentPoints,totalPoints));

// STEP 4: Write on the page a sentence that will say, "Your current grade is [CURRENT GRADE PERCENTAGE]%."
document.write(`Your current grade is ${currentGrade(currentPoints,totalPoints)}%.`);
...
let idealGrade = Number(prompt("What is the grade you want? 90, 80, 70 or 60?"));
